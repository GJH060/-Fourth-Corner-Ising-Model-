...
for (n in Ns) {
  for (p in Ps) {
    ...
    data_filename = file.path(rdata_dir, paste0("FCIR_data", infix, "_N", n, "_P", p, scenario_suffix, ".Rdata"))
    est_filename  = file.path(rdata_dir, paste0("FCIR_estimates_adaptive_lasso_", init_method, infix, "_N", n, "_P", p, scenario_suffix, ".Rdata"))
